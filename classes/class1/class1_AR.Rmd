...
#### we do not know much (anything) -- i don't know anything that i didn't tell it
...
# same as the previous, but I have the same issue.... need more details (maybe effort on my part as well... :,))
...
vote shares in upcoming election, future sales of a product, health status in medical study (CONT), disease diagnosis, victory / defeat in a sporting event, individ. voting decisions (DISC / CAT)

#### (b) Exploring associations

ID’ing risk factors f/ disease, attitudes that predict voting, chars. that make someone more successful in a job

#### (c) Extrapolation

polling, exp. data fr/ drug trial

#### (d) Causal inference

comparing outcomes under treatments / control – edu. study, outcome scores on standardised test
...
# too complicated, i have too much to do, sorry future me :(((

girlNames_plot <- ggplot(aes(x = yearNames_data, y = allNames_df$X)) +
  ggplot() +
  geom_line()
